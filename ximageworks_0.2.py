...
effect_menu = tk.OptionMenu(root, effect_var, "Pixel Prism", "Mosaic", "Halftone", "Posterize", "Voronoi", "Blur", "Acrylic Overlay", "Lima", "Movie Film", "Polaroid", "Sepia", "Cool", "Warm", "Vintage", command=update_sliders)
